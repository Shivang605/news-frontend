...
const Sports = () => {
  ...
  const ogNews = news[0] || {
    title: 'Sports News',
    slug: 'sports',
    summary: 'Discover the latest sports news on Samay Siwan.',
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Sports News | Samay Siwan</title>
        <meta
          name="description"
          content="Discover the latest sports news on Samay Siwan. Stay updated with national stories and headlines."
        />
        <meta name="keywords" content={keywords} />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="canonical" href="https://www.samaysiwan.com/sports" />

        <meta property="og:title" content={ogNews.title || 'Sports News | Samay Siwan'} />
        <meta property="og:description" content={ogNews.summary} />
        <meta property="og:image" content={ogNews.imageUrl} />
        <meta property="og:url" content="https://www.samaysiwan.com/sports" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Samay Siwan" />
        <meta property="og:locale" content="en_IN" />
        <meta property="article:published_time" content={ogNews.publishedDate} />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={ogNews.title || 'Sports News | Samay Siwan'} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Sports News',
            url: 'https://www.samaysiwan.com/sports',
            description: 'Discover the latest sports news on Samay Siwan, featuring national stories and headlines.',
            publisher: {
              '@type': 'Organization',
              name: 'Samay Siwan',
              logo: {
            ...
            mainEntity: {
              ...
              itemListElement: news.map((article, index) => ({
                ...
                item: {
                  ...
                  url: `https://www.samaysiwan.com/news/${article.id}/${article.slug}`,
      ...
      {news.length > 0 && (
        <section
          ...
          style={{ backgroundImage: `url(${news[0].imageUrl || 'https://via.placeholder.com/1920x1080?text=Top+Sports+News'})` }}
          itemScope
